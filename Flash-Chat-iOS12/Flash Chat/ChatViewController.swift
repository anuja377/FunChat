...
import  Firebase
class ChatViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate{   //data source to display data on table view
    
    // Declare instance variables here
    var messageArray : [Message] = [Message]() //blank array
